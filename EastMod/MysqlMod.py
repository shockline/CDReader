...
class MysqlMod:
    ...
    def Insert(self, table, line):
        ...
        sql = "INSERT INTO %s(Source,StockCode,StockName,CompanyCode,RateA,RateB,RateC,CompanyName,Author,Url,Title,Text,LabelMood,LabelRelate,Positive,Negative,Trade,Date,Time) VALUES (%s);" % (table, ','.join(Filed)) 
        try:
