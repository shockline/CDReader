...
#   
#   filename : CD_MultiTraining.py
#   author   : okcd00 / chendian@baidu.com
#   feat     : Ganbin Zhou @ ICS_ICT
#   date     : 2016-05-10
#   desc     : python CD_MultiTraining.py train
# ======================================================== 
    ...
    for _, _, files in os.walk(trainurl) :
        for filename in sorted(files) :
            if filename.startswith('Traintext_s'):
                ...
                traintext  = trainurl + "Traintext_s"  + signNum
                trainlabel = trainurl + "Trainlabel_s" + signNum 
                ...
                l.echo("TPR/%s\tFPR/%s\tAR /%s") % (str(tpr[index_of_one]), str(fpr[index_of_one]), str(ar))
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1 : # 0/*.py  1/mode  2/data  3/test  4/pooling
        ...
        print "Need Arguments. \"cd.py train\""
