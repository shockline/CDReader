#!/usr/bin/env python
# -*- encoding: utf-8 -*-
# Created on 2015-08-31 17:51:12
# Project: ReportList_sz10jqka
...
class Handler(BaseHandler):
    ...
    def on_start(self):
        for pos in xrange(0,len(stocklist)) :
            self.crawl(MainUrl, callback=self.index_page, save={"code":pos}, age=24*60*60, auto_recrawl=True, params={"preParams": "","querytype":"", "bgid":"", "edate":"", "sdate":"", "ts":"1", "f":"1", "qs":"1", "tid":"report", "w":str(stocklist[pos][1]).replace("sz","") } )
